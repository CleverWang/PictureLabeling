...
public class SelectInterests extends AppCompatActivity {
    ...
    private String[] allInterests = Interests.split(";");//所有兴趣
    private HashMap<String, String> interestsMap = new HashMap<>();//3级兴趣HashMap，用于快速获取兴趣
    ...
    private ListView level_1, level_2, level_3;//1,2,3级兴趣列表视图
    private ArrayAdapter<String> adapter_2, adapter_1, adapter_3;//1,2,3级兴趣列表视图适配器

    private ArrayList<String> interests = new ArrayList<>();//用户选择的所有兴趣
    private LinearLayout linearLayout_interests;//显示用户选择的兴趣的界面
